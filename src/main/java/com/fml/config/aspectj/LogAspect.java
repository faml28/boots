...
import com.fml.config.enums.BusinessStatus;
import com.fml.config.json.JSON;
import com.fml.config.manager.AsyncFactory;
import com.fml.config.manager.AsyncManager;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.fml.config.annotation.Log)")
